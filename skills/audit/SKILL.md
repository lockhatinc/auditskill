...
flowchart TD
    %% =========================================================================
    %% TOTAL SOUTH AFRICAN AUDITING & DUE DILIGENCE KNOWLEDGE GRAPH (2026)
    %% Deep Structural & Non-Linear Back-Referencing Architecture
    %% =========================================================================

    subgraph PHASE_0_GENESIS ["Phase 0: Entity Genesis, Structure, PI Score & Jurisdiction Scoping"]
        A01["Companies Act 71/2008 Reg 26-28 & 2024 Amendments<br/><i>(SA Parliament)</i><br/>Public Interest (PI) Score Calculation & Audit vs Independent Review Mandate"]
        A02["JSE Listings Requirements & Debt/Equity Directives<br/><i>(JSE / FSCA, 2024-2026)</i><br/>Accreditation, IFRS S1/S2 Compliance & Primary/Secondary Listing Scoping"]
        A03["SARB Financial Surveillance & Exchange Control Directives<br/><i>(South African Reserve Bank / FinSurv)</i><br/>Cross-Border Loop Structures, Capital Outflows & Authorized Dealer Approvals"]
        A04["FICA Schedule 1 (Accountable Institutions) & GLAA 2022/2026<br/><i>(FIC / SA Parliament)</i><br/>Ultimate Beneficial Ownership (UBO), Targeted Financial Sanctions (TFS) & PEP Matrix"]
        A05["National Payment System Act 78/1998 & FSRA 9/2017 Twin Peaks<br/><i>(SARB / PA / FSCA)</i><br/>Financial Sector Prudential Standards & Crypto Asset Service Provider (CASP) Scoping"]
    end

    subgraph PHASE_1_PRE_ENGAGEMENT ["Phase 1: Pre-Engagement, Ethics, Quality & Forensic Vetting"]
        B01["ISQM 1 & ISQM 2 Frameworks<br/><i>(IAASB, 2022-2025)</i><br/>Firm-Wide Risk Assessment, Remediation Monitoring & EQCR Assignment"]
        B02["IRBA Code of Conduct & SAICA By-Laws (2024/2026 Edition)<br/><i>(IRBA / SAICA / IESBA)</i><br/>Independence, Long Association, Fee Dependency (>15% cap) & NOCLAR Protocols"]
        B03["Companies Act Sec 90-93 & JSE Mandatory Rotation Guidance<br/><i>(SA Parliament / IRBA / JSE)</i><br/>Statutory Auditor Disqualification & Designated Partner 5-Year Cooling-Off"]
        B04["ISA 210 & Engagement Terms Structuring<br/><i>(IAASB)</i><br/>Scope Definition, Preconditions Verification & Tripartite Governance Engagement"]
        B05["Forensic Integrity Screening & PRECCA Act 12/2004<br/><i>(SA Parliament)</i><br/>Bribery, Gratification, Whistleblower & Corruption Background Checks"]
    end

    subgraph PHASE_2_PLANNING_RISK ["Phase 2: Strategy, Risk Assessment & Combined Assurance"]
        C01["ISA 300 & Combined Assurance Architecture<br/><i>(IAASB / King IV Principle 15)</i><br/>Integration of 1st (Ops), 2nd (Risk/Comp), 3rd (IA), 4th (External) & 5th (Regulators) Lines"]
        C02["ISA 315 (Revised 2019/2024) Deep Spectrum Analysis<br/><i>(IAASB)</i><br/>Inherent Risk Factors: Complexity, Subjectivity, Uncertainty, Change & Susceptibility to Bias"]
        C03["ITGC, COBIT 2019 & ISO/IEC 27001 Assessment<br/><i>(ISACA / ISO)</i><br/>Logical Access, Program Changes, Computer Ops, Cloud Security & CI/CD Pipelines"]
        C04["POPIA Act 4/2013 & Cybercrimes Act 19/2020<br/><i>(Information Regulator / SA Parliament)</i><br/>Data Subject Consent, Cross-Border Transfer Sec 72 & Ransomware Threat Vector Audit"]
        C05["COSO Internal Control 2013 17 Principles<br/><i>(COSO / Treadway Commission)</i><br/>Entity-Level Control Environment, Delegation of Authority & Governance Maturity"]
        C06["ISA 320, ISA 450 & Qualitative Multipliers<br/><i>(IAASB)</i><br/>Overall Materiality, Performance Materiality (PM), SAD Trivial & Debt Covenant Haircut"]
        C07["ISA 240 Fraud Brainstorming & Benford Analysis<br/><i>(IAASB / Frank Benford / Mark Nigrini)</i><br/>Management Override, Unscheduled Journal Entry Patterns & Off-Book Vehicles"]
        C08["ISA 600 (Revised) Multi-Tiered Group Auditing<br/><i>(IAASB)</i><br/>Significant Component Thresholds, Cross-Border Auditor Oversight & Intercompany Balancing"]
        C09["Labour Relations Act 66/1995 & BCEA Act 75/1997<br/><i>(SA Parliament / CCMA)</i><br/>Strikes, Section 197 Business Transfers, Retrenchment & Unfunded Labour Accruals"]
    end

    subgraph PHASE_3_SUBSTANTIVE_EXECUTION ["Phase 3: Substantive Execution, Forensic Evidence & ESG"]
        D01["ISA 330 Dual-Purpose Testing Strategy<br/><i>(IAASB)</i><br/>Alignment of Tests of Controls (TOC) with Inherent & Control Risk (CR) Baselines"]
        D02["Automated Control Validation (ITAC / Segregation of Duties)<br/><i>(ISACA / COSO)</i><br/>Automated Three-Way Matching, Configured Approval Limits & SOD Matrix Violations"]
        D03["ISA 500, 501, 505 Direct External Verification<br/><i>(IAASB)</i><br/>SWIFT MT940 Direct Bank Feeds, Electronic Debtors Circularisation & Physical Stock Counts"]
        D04["ISA 520 Advanced Substantive Analytics<br/><i>(IAASB)</i><br/>Multivariate Linear Regressions, Industrial Capacity Yield Models & Unit Margin Proofs"]
        D05["ISA 530 & Monetary Unit Sampling (MUS)<br/><i>(IAASB / Guy, Carmichael, Whittington)</i><br/>High-Value Stratification, Stringer Bound Extrapolations & Understatement Taint Analysis"]
        D06["ISA 540 (Revised) Complex Valuation & Estimations<br/><i>(IAASB / IFRS Foundation)</i><br/>IFRS 9 ECL (Macroeconomic Forward PD/LGD/EAD), IFRS 13 Fair Value Level 3 & IFRS 17"]
        D07["ISA 550 & Companies Act Sec 45/75 Related Party Audits<br/><i>(IAASB / SA Parliament)</i><br/>Intercompany Guarantees, Subordinated Financial Assistance & Director Self-Dealing Checks"]
        D08["Tax Administration Act 28/2011 & Income Tax Act 58/1962<br/><i>(SARS / SA Parliament)</i><br/>Corporate Income Tax (CIT), VAT 89/1991 Input/Output, Sec 31 Transfer Pricing & ETI"]
        D09["ISSA 5000, ISAE 3410 & IFRS S1/S2 ESG Assurance<br/><i>(IAASB / ISSB, 2024-2026)</i><br/>Scope 1, 2, 3 GHG Emissions, Carbon Tax Act 15/2019 & Sustainability Claims Verification"]
        D10["B-BBEE Codes of Good Practice (Dtic / Generic & Sector Charters)<br/><i>(B-BBEE Commission / dtic)</i><br/>Ownership Points, Enterprise and Supplier Development (ESD) & Socio-Economic (SED) Checks"]
    end

    subgraph PHASE_4_SPECIAL_CHECKS ["Phase 4: Statutory Breaches, Irregularities & Solvency Audits"]
        E01["APA Act 26/2005 Section 45 Reportable Irregularities (RI)<br/><i>(IRBA / SA Parliament)</i><br/>Identification of Unlawful Acts/Omissions Causing Financial Loss or Fiduciary Breach"]
        E02["Companies Act Sec 4 Solvency & Liquidity Diagnostic<br/><i>(SA Parliament)</i><br/>Forward-Looking 12-Month Asset/Liability & Cash Liquidity Post-Distribution Verification"]
        E03["PFMA Act 1/1999 & MFMA Act 56/2003 Auditing (Public Sector/AGSA)<br/><i>(National Treasury / AGSA)</i><br/>Fruitless, Wasteful, Unauthorized, and Irregular Expenditure (UIFW) Matrix"]
        E04["Competition Act 89/1998 & Competition Amendment Act 18/2018<br/><i>(Competition Commission SA)</i><br/>Cartel Conduct, Collusive Tendering, Abuse of Dominance & Unapproved Mergers"]
        E05["National Environmental Management Act (NEMA Act 107/1998)<br/><i>(DFFE / SA Parliament)</i><br/>Mining Rehabilitation Guarantees, Environmental Liabilities & Closure Provisions"]
    end

    subgraph PHASE_5_EVALUATION_REVIEW ["Phase 5: Synthesis, Subsequent Events, Going Concern & Cold Reviews"]
        F01["ISA 560 Dual-Period Subsequent Events Investigation<br/><i>(IAASB)</i><br/>Type I (Adjusting Facts Existing at Year-End) vs Type II (Non-Adjusting Post-Year-End)"]
        F02["ISA 570 (Revised) Going Concern & Stress-Testing Models<br/><i>(IAASB / Companies Act Sec 4)</i><br/>Working Capital Headroom, Debt Maturity Walls, Interest Rate Shocks & Covenant Breaches"]
        F03["ISA 450 Summary of Unadjusted Audit Differences (SUAD)<br/><i>(IAASB)</i><br/>Aggregation of Fact, Judgmental & Projected Misstatements against Final Performance Materiality"]
        F04["ISA 580 Comprehensive Management & TCWG Representation Letters<br/><i>(IAASB)</i><br/>Statutory Affidavits, Contingent Liabilities, Off-Balance Sheet Assurances & UBO Disclosures"]
        F05["ISA 260 & ISA 265 TCWG Governance Communication<br/><i>(IAASB / King IV Principle 17)</i><br/>Audit Findings, Internal Control Deficiency Matrix & Governance Recommendations"]
        F06["ISA 220 (Revised) & ISQM 2 EQCR Hot-Review Clearance<br/><i>(IAASB)</i><br/>Objective Evaluation of Significant Judgments, Working Paper Evidence & Sign-Off Gating"]
    end

    subgraph PHASE_6_REPORTING_LODGEMENT ["Phase 6: Reporting, Public Disclosures & Digital Statutory Filing"]
        G01["ISA 700 (Rev), 701, 705, 706 Audit Opinion Architecture<br/><i>(IAASB)</i><br/>Unmodified, Qualified, Adverse, or Disclaimer + Key Audit Matters (KAMs) Synthesis"]
        G02["IRBA Section 45 Phase-2 Statutory Resolution Filing<br/><i>(IRBA Enforcement Directorate)</i><br/>30-Day Determination: Irregularity Remediated vs Continuing/Ongoing Letter"]
        G03["CIPC iXBRL Mandated Filing & Financial Governance Matrix<br/><i>(CIPC / SA Parliament)</i><br/>Full IFRS / IFRS for SMEs XBRL Digital Taxonomy Tagging & AFS Lodgement"]
        G04["SARS Supplementary Declaration (ITR14 & Country-by-Country / Master File)<br/><i>(SARS)</i><br/>Transfer Pricing Local/Master File Filing, Tax Schedule Reconciliations & Base Erosion Audits"]
    end

    %% =========================================================================
    %% FORWARD STRUCTURAL EDGES
    %% =========================================================================
    A01 --> A02 --> A03 --> A04 --> A05
    A05 --> B01 --> B02 --> B03 --> B04 --> B05
    B05 --> C01
    C01 --> C02 & C03 & C04 & C05 & C06 & C07 & C08 & C09
    C02 & C03 & C04 & C05 & C06 & C07 & C08 & C09 --> D01
    D01 --> D02 & D03 & D04 & D05 & D06 & D07 & D08 & D09 & D10
    D02 & D03 & D04 & D05 & D06 & D07 & D08 & D09 & D10 --> E01
    E01 --> E02 & E03 & E04 & E05
    E02 & E03 & E04 & E05 --> F01
    ...
    %% =========================================================================
    %% NONLINEAR BACKREFERENCES & BALANCING FEEDBACK LOOPS
    %% =========================================================================

    %% Loop 1: PI Score Calculation triggers higher statutory / scoping loops
    A01 --"PI Score >= 350 or Public Entity<br/>[Force Full IFRS, Mandatory Audit & KAMs Under ISA 701]"--> B03
    A01 --"PI Score Threshold Elevation"--> C06

    %% Loop 2: Exchange Control / SARB Violation Triggers RI and Special Scoping
    A03 --"Unauthorized Cross-Border Transfers / FinSurv Breach<br/>[Back-Ref: Direct Trigger of APA Sec 45 RI]"--> E01

    %% Loop 3: ITGC & Cyber Security Failure Reverts to Risk & Strategy
    C03 --"Critical ITGC Breakdown / Segregation Defect<br/>[Back-Ref: Invalidate TOC Strategy; Maximize Inherent Risk]"--> C02
    C03 --"System Access Breach / POPIA Violation<br/>[Back-Ref: Trigger Regulatory Non-Compliance Assessment]"--> C04
    C03 --"Automated Controls Ineffective: Nullify Reliance"--> D02

    %% Loop 4: TOC Failure Back-References
    D02 --"Automated Controls Fail (High Deviations)<br/>[Back-Ref: Re-evaluate Control Risk & Expand Substantive Sample Size]"--> C02
    D02 --"Sample Deviation Exceeds Tolerable Error"--> D05

    %% Loop 5: Substantive Sampling Misstatement Extrapolation Loop
    D05 --"Projected Error (Stringer Bound) > Performance Materiality<br/>[Back-Ref: Force SUAD Schedule & Re-estimate Materiality]"--> C06
    D05 --"Audit Discrepancies Cluster in Single Division<br/>[Back-Ref: Expand Fraud Investigation Scope (ISA 240)]"--> C07

    %% Loop 6: Transfer Pricing & Tax Exposures Triggering Estimates & Solvency
    D08 --"Transfer Pricing / Aggressive Base Erosion Exposure Identified<br/>[Back-Ref: Model SARS Uncertain Tax Provision (IAS 12 / IFRIC 23)]"--> D06
    D08 --"Potential Tax Assessment Threatens Liquidity"--> E02

    %% Loop 7: Reportable Irregularities (APA Section 45) Multi-Directional Back-Loops
    E01 --"Section 45 1st Report Dispatched to IRBA (Day 1 Clock Active)<br/>[Mandatory Notification to Board & Audit Committee]"--> F05
    E01 --"Unresolved RI at Day 30 Reporting Date<br/>[Back-Ref: Force Modified Opinion (ISA 705) / KAM Disclosure (ISA 701)]"--> G01

    %% Loop 8: Solvency & Liquidity Test Breach Loops to Going Concern and Directors
    E02 --"Companies Act Sec 4 Breach (Assets < Liabilities or Cash Deficit)<br/>[Back-Ref: Direct Feed to ISA 570 Going Concern Stress-Testing]"--> F02
    E02 --"Reckless Trading Condition (Companies Act Sec 22)<br/>[Back-Ref: Trigger Section 45 Reportable Irregularity]"--> E01
    E02 --"Director Personal Liability Notification (Companies Act Sec 77)"--> D07

    %% Loop 9: Competition / NEMA Environmental Liabilities Feeding Accounting Estimates
    E04 & E05 --"Cartel Fines / Mining Rehabilitation Deficits Identified<br/>[Back-Ref: Mandatory Revision of IAS 37 Provisions & Estimates]"--> D06

    %% Loop 10: Subsequent Events (ISA 560) Triggering Fieldwork & Estimation Loops
    F01 --"Type I Adjusting Event (Customer Insolvency / Asset Destruction)<br/>[Back-Ref: Adjust IFRS 9 ECL & ISA 540 Valuations]"--> D06
    F01 --"Type II Non-Adjusting Catastrophic Event (Post-Balance Date Collapse)<br/>[Back-Ref: Re-evaluate Going Concern & Debt Headroom]"--> F02

    %% Loop 11: Going Concern (ISA 570) Material Uncertainty Triggering Disclosures
    F02 --"Insolvency Risk Unmitigated by Management Plan<br/>[Back-Ref: Re-open Summary of Misstatements]"--> F03
    F02 --"Material Uncertainty Identified (MURGC Paragraph or Adverse Opinion)"--> G01

    %% Loop 12: EQCR / Quality Management Rejection & Fieldwork Re-Opening
    F06 --"EQCR Refuses Sign-Off (Insufficient Appropriate Evidence)<br/>[Back-Ref: Re-open Substantive Fieldwork & Gather Direct Corroboration]"--> D01
    F06 --"Defective Estimates Valuation Review<br/>[Back-Ref: Commission Independent Auditor Expert (ISA 620)]"--> D06
```
